...
#define UbiquityContainerIdentifiers @"iCloud.com.chenxi.caihongdaojishi"
...
+ (void)saveCloudKitModelWithTitle:(NSString *)title content:(NSString *)content photoImage:(NSData *)pcmDate
{
...
//    }
    ...
    [noteRecord setValue:title forKey:@"titleString"];
    [noteRecord setValue:content forKey:@"contentString"];
