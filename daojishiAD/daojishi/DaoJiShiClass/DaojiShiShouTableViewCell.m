...
@implementation DaojiShiShouTableViewCell
...
- (void)createSubViews{
    ...
    self.bgView = [[UIView alloc]initWithFrame:CGRectMake(kAUTOWIDTH(15), 0, ScreenWidth - kAUTOWIDTH(30), kAUTOHEIGHT(55))];
    [self.contentView addSubview:self.bgView];

    self.gradientLayer = [CAGradientLayer layer];
    self.gradientLayer.frame = self.bgView.frame;
    self.gradientLayer.colors = @[(id)[DaojiShiShouTableViewCell toUIColorByStr:self.bgColor1].CGColor, (id)[DaojiShiShouTableViewCell toUIColorByStr:self.bgColor2].CGColor];
    ...
    //    DBLCDTempBlack
    self.timeLabel = [[UILabel alloc]initWithFrame:CGRectMake(ScreenWidth - kAUTOWIDTH(40)- (ScreenWidth - kAUTOWIDTH(80)), kAUTOHEIGHT(0), ScreenWidth - kAUTOWIDTH(80), kAUTOHEIGHT(55))];
    self.timeLabel.font = [UIFont fontWithName:@"DBLCDTempBlack" size:24];
...
- (void)cellSetContentViewWithModel:(LZDataModel *)model{
    ...
    self.gradientLayer.colors =  self.gradientLayer.colors = @[(id)[DaojiShiShouTableViewCell toUIColorByStr:self.bgColor1].CGColor, (id)[DaojiShiShouTableViewCell toUIColorByStr:self.bgColor2].CGColor];

    _subLayer.shadowColor = [DaojiShiShouTableViewCell toUIColorByStr:self.bgColor1].CGColor;
