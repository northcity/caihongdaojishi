...
- (instancetype)init {
    ...
    if (self) {
        ...
        UIImageView *touchImageView = [[UIImageView alloc]initWithFrame:CGRectMake(ScreenWidth/2 - kAUTOWIDTH(70)/2, PCTopBarHeight + kAUTOWIDTH(50), kAUTOWIDTH(70), kAUTOWIDTH(70))];
        
        [_vc.view addSubview:touchImageView];
        touchImageView.image = [UIImage imageNamed:@"shannianicon1024"];
        _vc.view.backgroundColor = [UIColor whiteColor];
       
        touchImageView.layer.cornerRadius = kAUTOWIDTH(14);
        touchImageView.layer.masksToBounds = YES;
        CALayer *subLayer=[CALayer layer];
        CGRect fixframe=touchImageView.layer.frame;
        subLayer.frame = fixframe;
        subLayer.cornerRadius = kAUTOWIDTH(14);
        ...
        button.frame = CGRectMake(ScreenWidth/2 - kAUTOWIDTH(70), CGRectGetMaxY(touchImageView.frame) + kAUTOWIDTH(30), kAUTOWIDTH(55), kAUTOWIDTH(55));
...
//        button.backgroundColor = [UIColor redColor];
        ...
        label.frame = CGRectMake(ScreenWidth/2 - kAUTOWIDTH(150)/2, CGRectGetMaxY(button.frame) + kAUTOWIDTH(20), kAUTOWIDTH(150), 30);
